...
if [ ! -e ubuntu-base-gnome-arm64-*.tar.gz ]; then
...
sudo tar -xpf ubuntu-base-gnome-arm64-*.tar.gz
...
sudo cp -rpf packages/$ARCH/$DEB/*.deb $TARGET_ROOTFS_DIR/packages/install_packages
...
echo -e "\033[47;36m ---------- DHDAXCW -------- \033[0m"
\${APT_INSTALL} gdisk parted

#Desktop background picture
ln -sf /usr/share/xfce4/backdrops/h88k-wallpaper.png /usr/share/backgrounds/warty-final-ubuntu.png
